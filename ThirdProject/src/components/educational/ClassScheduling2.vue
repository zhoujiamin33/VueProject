	...
	<el-col :span="24" class="el-center-top-labels" style="border-bottom: 1px solid #e8eaec;">
				<div class="el-center-title-content">
					<div class="ivn-page-header-main">
						...
						<div class="ivn-page-header-row" style="display: flex;flex-direction: row;">
							<div class="ivu-page-header-content" style="margin-right: 170px;" >
								排课班级
							</div>
							<div class="ivu-page-header-content" style="margin-right:170px;">
								可用教室
				...
				<div style="margin-left:450px;margin-top:0px;margin-left:-385px;" :rules="rules">
					<el-select  v-model="form.classlist"  placeholder="请选择排课班级" 
						collapse-tags multiple filterable clearable style="width: 200px;margin-top: 20px;margin-left:370px;margin-right: 30px;">
					    <el-option  v-for="classes in classesdata" :label="classes.classesName" :value="classes.classesId" style="width: 150px;"></el-option>
					</el-select>
					
					<el-select v-model="form.classrooms" filterable placeholder="请选择教室"  style="width: 200px;margin-right: 30px;" multiple clearable collapse-tags>
						<el-option  v-for="item in classroomdata" :value="item.classroomId" :label="item.classroomName"  style="width: 150px;"></el-option>
					</el-select>
					
					<el-select v-model="form.periods" filterable placeholder="请选择排课时段"  style="width: 200px;margin-right: 30px;" multiple clearable collapse-tags>
					...
					<el-input v-model="form.coursecount" placeholder="请输入排课次数"
					 @change="chaosan"  max="3" min="0" type="number" style="width: 150px;align-self: center;margin-right: 30px;"></el-input>&nbsp;
					<el-button type="primary" @click="insertScheduling" style="margin-left: 70px;">点击排课</el-button>
					
					<!-- 排课设置 -->
					
					<el-button type="primary" style="margin-left:110px;" @click="dialogform=true">
					...
					<el-dialog title="排课设置" v-model="dialogform">
						<el-form>
							<el-form-item label="可用教室：">
								<el-select v-model="form.classrooms" filterable placeholder="请选择教室"  style="width: 200px;" multiple clearable collapse-tags>
								   <el-option  v-for="item in classroomdata" :value="item.classroomId" :label="item.classroomName"  style="width: 150px;"></el-option>
								</el-select>
							</el-form-item>
							...
							<el-form-item label="可用时间：">
								<el-select v-model="form.periods" filterable placeholder="请选择排课时段"  style="width: 200px;" multiple clearable collapse-tags>
									<el-option  v-for="period in periodData" :label="period.period" :value="period.periodId" style="width: 150px;"></el-option>
								</el-select>
							</el-form-item>
